 ...
 *
 * LA QUESTION EST TRANCHÉE, ET PAR REDPAR : « PLAFOND À 1/5000, VÉRIFIÉ
 * EXPÉRIMENTALEMENT le 28/07/2026 : une demande à 1/10000 est SILENCIEUSEMENT
 * SERVIE À 1/1000 par le service du cadastre. Pas de refus, pas de message —
 * le cartouche indique 1/1000 et le plan couvre dix fois moins de terrain que
 * demandé. » La liste honorée y est établie : 1000, 1250, 1500, 2000, 2500,
 * 4000, 5000. On ne sort pas de là sans refaire l'essai.
 *
 * CERTIF n'en retient que le haut. Une A4 au 1/1000 couvre 195 × 211 mètres :
 * c'est un plan de masse, et R*410-1 demande de situer le terrain DANS la
 * commune.
 */
export const ECHELLES = (process.env.CERTIF_PLAN_ECHELLES || '2000,2500,4000,5000')
