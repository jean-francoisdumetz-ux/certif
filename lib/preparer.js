...
function avertir(demande, etatSignature, plan, planEchec) {
  ...
  // service d'urbanisme.
  if (plan && plan.voie === 'tuiles') {
    liste.push('le plan joint n’est PAS l’extrait cadastral officiel : PAINT n’a pas répondu, '
      + 'CERTIF a fabriqué une carte de situation sur fond IGN');
  }
