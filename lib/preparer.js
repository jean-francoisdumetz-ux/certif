...
function avertir(demande, etatSignature, plan, planEchec) {
  ...
  // service d'urbanisme.
  if (plan && plan.voie === 'paint') {
    liste.push('le plan joint est l’extrait cadastral officiel, sur lequel la parcelle '
      + 'N’EST PAS colorée : le service la retrouve par sa référence imprimée');
  }
