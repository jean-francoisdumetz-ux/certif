 ...
 * s'étend de 288,0 à 306,2 points, sur une ligne de base à 12,6 points du bas,
 * sous les deux filets qui courent à 39,0 et 28,4 points. La mention se pose à
 * 314 points, immédiatement à sa droite, sans rien recouvrir.
 */
async function numeroterDossier(document, reference) {
  ...
  for (const numero of PAGES_DEMANDE) {
    ...
    page.drawText(`Dossier ${reference}`, {
      x: 314, y: 12.6, size: 8.5, font: f.sans, color: rgb(0.42, 0.45, 0.5),
    });
  }
}
