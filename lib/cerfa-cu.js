...
export async function remplirCerfa(d, images = {}) {
  ...
  return extraire(document, PAGES_DEMANDE);
}
 ...
 *
 * CE PIED EST À 4,7 mm DU BORD, et c'est l'imprimé officiel qui en décide, pas
 * nous. La plupart des imprimantes laser ne savent pas descendre en dessous de
 * 4 à 5 mm : imprimée « à 100 % », la page perd sa numérotation. C'est pourquoi
 * les consignes envoyées à l'assistante demandent « ajuster à la zone
 * imprimable » — le formulaire sort alors à 96 %, entier.
 */
...
async function extraire(source, numeros) {
