 ...
 *
 * La série commence à 1/5 000 et non plus bas, alors que le calcul, laissé
 * libre, descendait à 1/2 000 pour une parcelle ordinaire. Une carte de trois
 * cents mètres de large est un plan de masse : elle montre la parcelle et ses
 * voisines, pas le terrain DANS la commune. Or c'est précisément ce que demande
 * R*410-1. À 1/5 000, le cadre couvre environ huit cents mètres — de quoi voir
 * un quartier, une voie principale, un repère.
 */
export const ECHELLES = [5000, 10000, 25000, 50000];
 ...
 */
export function choisirZoom(echelle, lat, { min = 10, max = 18 } = {}) {
